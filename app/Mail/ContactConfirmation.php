...
class ContactConfirmation extends Mailable
{
    ...
    {
        return $this->subject('Confirmation de votre demande de contact')
            ->html($this->buildHtml());
    }
                                    ...
                                    <td>
                                        ...
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                            <tr>
                                                ...
                                                <td style="vertical-align: top;">
                                                    <h4 style="margin: 0 0 5px; color: #8B7355; font-size: 14px; font-weight: bold; text-transform: uppercase;">Contact au nom de</h4>
